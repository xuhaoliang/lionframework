package com.hzgroup.lionframework.generator.engine.base;
 ...
 */
public abstract class LionTemplateEngine extends AbstractTemplateEngine {

    private GroupTemplate groupTemplate;

    public LionTemplateEngine() {
        initBeetlEngine();
    }
