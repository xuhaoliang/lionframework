package com.hzgroup.lionframework.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "lionTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\lion";//模板输出的项目目录
    ...
    private String proPackage = "com.hzgroup.lionframework.admin";
    private String coreBasePackage = "com.hzgroup.lionframework.core";
    private String modelPackageName = "com.hzgroup.lionframework.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.hzgroup.lionframework.admin.common.persistence.dao";  //model的dao
