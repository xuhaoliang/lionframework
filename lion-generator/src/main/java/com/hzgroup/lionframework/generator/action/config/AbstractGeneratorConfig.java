package com.hzgroup.lionframework.generator.action.config;
...
import com.hzgroup.lionframework.generator.engine.base.LionTemplateEngine;
import com.hzgroup.lionframework.generator.engine.config.ContextConfig;
import com.hzgroup.lionframework.core.util.FileUtil;
import com.hzgroup.lionframework.generator.engine.SimpleTemplateEngine;
import com.hzgroup.lionframework.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doLionGeneration() {
        LionTemplateEngine LionTemplateEngine = new SimpleTemplateEngine();
        LionTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        LionTemplateEngine.setSqlConfig(sqlConfig);
        LionTemplateEngine.setTableInfo(tableInfo);
        LionTemplateEngine.start();
    }
}
