package com.hzgroup.lionframework.rest.modular.auth.converter;
...
import com.hzgroup.lionframework.rest.config.properties.JwtProperties;
import com.hzgroup.lionframework.rest.modular.auth.security.DataSecurityAction;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new LionException(BizExceptionEnum.SIGN_ERROR);
        }
