...
import com.hzgroup.lionframework.core.base.tips.ErrorTip;
...
import static com.hzgroup.lionframework.core.support.HttpKit.getRequest;
...
public class GlobalExceptionHandler {
     ...
     * @author fengshuonan
     */
    @ExceptionHandler(LionException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public ErrorTip notFount(LionException e) {
