...
package com.hzgroup.lionframework.core.flowable;
 ...
 */
public class LionDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public LionDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public LionDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
