package com.hzgroup.lionframework.modular.code.factory;


import com.hzgroup.lionframework.LionApplication;
import com.hzgroup.lionframework.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setProjectPackage(LionApplication.class.getPackage().getName());
