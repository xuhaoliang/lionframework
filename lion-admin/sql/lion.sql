...
DROP DATABASE IF EXISTS lion_flowable;
CREATE DATABASE IF NOT EXISTS lion_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS lion;
CREATE DATABASE IF NOT EXISTS lion DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用Lion管理系统', '2017-01-11 08:53:20', '1');
