package com.hzgroup.lionframework.core.mutidatasource.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "lion.muti-datasource")
public class MutiDataSourceProperties {

    private String defaultDataSourceName = "dataSourceLion";
